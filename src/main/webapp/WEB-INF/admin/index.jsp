    ...
    <div class="admin-sidebar am-offcanvas  am-padding-0" id="admin-offcanvas">
        <div class="am-offcanvas-bar admin-offcanvas-bar">
            ...
            <ul class="am-list admin-sidebar-list">
                <li><a href="../view/index.html"><span class="am-icon-home"></span> 首页</a></li>
                <li class="admin-parent">
                    ...
                    <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav1">
                        <li><a href="../view/table_basic.html" class="am-cf"> <span>基本表格</span></a></li>
                        <li><a href="../view/table_complete.html">完整表格</a></li>
                    </ul>
                </li>
                <li class="admin-parent">
                    ...
                    <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav2">
                        <li><a href="../view/chart_line.html" class="am-cf"> <span>折线图</span></a></li>
                        <li><a href="../view/chart_columnar.html" class="am-cf"> <span>柱状图</span></a></li>
                        <li><a href="../view/chart_pie.html" class="am-cf"> <span>饼状图</span></a></li>
                    </ul>
                </li>
                <li class="admin-parent">
                    ...
                    <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav5">
                        <li><a href="../view/form_basic.html" class="am-cf"> 基本表单</a></li>
                        <li><a href="../view/form_validate.html">表单验证</a></li>
                    </ul>
                </li>
            </ul>
        </div>
                        ...
                        <div class="inbox-widget nicescroll" style="height: 315px; overflow: hidden; outline: none;"
                            ...
                            <a href="#">
                                <div class="inbox-item">
                                    <div class="inbox-item-img"><img src="../img/avatar-1.jpg" class="img-circle"
                                                                     alt=""></div>
                            ...
                            <a href="#">
                                <div class="inbox-item">
                                    <div class="inbox-item-img"><img src="../img/avatar-2.jpg" class="img-circle"
                                                                     alt=""></div>
                            ...
                            <a href="#">
                                <div class="inbox-item">
                                    <div class="inbox-item-img"><img src="../img/avatar-10.jpg" class="img-circle"
                                                                     alt=""></div>
                            ...
                            <a href="#">
                                <div class="inbox-item">
                                    <div class="inbox-item-img"><img src="../img/avatar-4.jpg" class="img-circle"
                                                                     alt=""></div>
                            ...
                            <a href="#">
                                <div class="inbox-item">
                                    <div class="inbox-item-img"><img src="../img/avatar-5.jpg" class="img-circle"
                                                                     alt=""></div>
...
<script type="application/javascript">
    $.ajax({
        type: "GET",
        url: '<%=request.getContextPath()%>/userLog/findList?pageNum=1&pageSize=10',
